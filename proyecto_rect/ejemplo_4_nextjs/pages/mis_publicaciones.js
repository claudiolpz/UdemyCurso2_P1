...
import { getAvisos, getCategorias, addAvisos, editarAvisos, deleteAvisos } from "@/services/ApiRest";
                    ...
                    <table className="table table-bordered table-striped table-hover">
                      ...
                      <tbody>
                        {avisos.datos.map((aviso)=>(
                            ...
                            <td>
                            <ModalImage 
                            small={`${process.env.NEXT_PUBLIC_BASE_URL_LOCAL}uploads/avisos/${aviso.foto}`} 
                            large={`${process.env.NEXT_PUBLIC_BASE_URL_LOCAL}uploads/avisos/${aviso.foto}`} 
                            alt={aviso.nombre}   />
                            </td>
                            <td className="center">
