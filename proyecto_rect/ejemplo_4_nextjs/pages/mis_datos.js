...
import { authMisDatos } from "@/services/ApiRest";
...
const misDatos = ({
  ...
  const [nombre, setNombre] = useState(cookies.tokenTamilaNombre);
  const [correo, setCorreo] = useState(cookies.tokenTamilaCorreo);
