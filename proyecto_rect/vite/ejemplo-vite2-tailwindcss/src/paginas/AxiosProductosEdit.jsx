...
import { getProductosPorId, editProductos, getCategorias } from "../servicios/ApiAxios";
...
export async function action({request, params}) {
    ...
    if (Object.keys(errores).length) {
     ...
     if((await editProductos({nombre: datos.nombre, descripcion: datos.descripcion, 
        precio: datos.precio, stock: datos.stock, categorias_id: datos.categorias_id}, params.id))===201)
        {
            Swal.fire({
                icon:'success',
                title:'Ok',
...
const AxiosProductosEdit = () => {
  ...
  return (
    <div>
      ...
      <h1 className="text-center mb-2">Productos Editar</h1>
      <hr className="mb-4" />
      ...
      <Form method="post" noValidate className="max-w-sm mx-auto">
        <div className="mb-5">
          ...
          <select
            id="categorias_id"
            name="categorias_id"
            defaultValue={datos.categorias_id}
