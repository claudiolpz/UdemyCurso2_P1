...
import { webpayCrearOrden } from "../servicios/ApiWebpay";

export async function loader() {
  let datos = webpayCrearOrden({ amount: 10000 });
  return datos;
}
const PasarelasWebpay = () => {
    ...
    <div>
      ...
      <div>
        <ul className="pl-5 ml-7 mt-3 list-disc">
          ...
          <li>
            <strong>Token</strong>: {datos.token}
          </li>
          <li>
      ...
      <div>
        <form action={datos.url} method='post' name='form'>
...
export default PasarelasWebpay;
