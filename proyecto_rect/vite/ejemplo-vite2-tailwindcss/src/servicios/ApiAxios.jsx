...
export async function addCategorias(request) {
  let datos = axios.post(`${import.meta.env.VITE_API_URL}categorias`,
    request, {
      headers: cabeceros
    }
  ).then((response)=>{
...
export async function editCategorias(request, id) {
  let datos = axios.put(`${import.meta.env.VITE_API_URL}categorias/${id}`,
    request, {
      headers: cabeceros
    }
  ).then((response)=>{
...
export async function deleteCategorias(id) {
  let datos = axios.delete(`${import.meta.env.VITE_API_URL}categorias/${id}`,
    {
      headers: cabeceros
    }
  ).then((response)=>{
